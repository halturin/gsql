...
void
nav_tree_refresh_type_columns (GSQLNavigation *navigation,
			GtkTreeView *tv,
			GtkTreeIter *iter)
{
	GSQL_TRACE_FUNC;
...
/* 		nav_tree_refresh_type_columns,		// expand_handler */
/* 		NULL,					// event_handler */
/* 		NULL, 0},				// child, childs */
/* }; */
			...
			GtkTreeIter *iter)
{
	...
	//GSQL_DEBUG("DBG - Types: Owner [%s]", owner);
