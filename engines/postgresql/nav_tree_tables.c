...
"  				<menuitem name=\"PGSQLTableCreate\" action=\"PGSQLActionTableCreate\" />	"
//"  				<menuitem name=\"PGSQLTableDrop\" action=\"PGSQLActionTableDrop\" />		"
//"  				<menuitem name=\"PGSQLTableAlter\" action=\"PGSQLActionTableAlter\" />		"
"  				<menuitem name=\"PGSQLTableBrowse\" action=\"PGSQLActionTableBrowse\" />	"
"	    </placeholder> "
"  </popup> "
"</ui>";
...
/*	{ "PGSQLActionTableDrop", GTK_STOCK_DELETE, 
	...
	{ "PGSQLActionTableAlter", NULL, 
		N_("Alter..."), NULL, 
		N_("Alter table"), 
		G_CALLBACK(on_popup_table_alter) },
*/	
	{ "PGSQLActionTableBrowse", NULL, 
	  N_("Browse data"), NULL, 
