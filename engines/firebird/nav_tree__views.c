...
"  				<menuitem name=\"FirebirdViewBrowse\" action=\"FirebirdActionViewBrowse\" />		"
"  		</placeholder>																				"
"  </popup>																								"
"</ui> ";
						 ...
						 GtkTreeIter *iter, guint event)
{
	...
	if (!gsql_navigation_get_action (navigation, "FirebirdActionViewBrowse"))
	{
		actions = gtk_action_group_new ("FirebirdPopupViewActions");
