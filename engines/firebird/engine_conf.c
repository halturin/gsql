...
engine_conf_widget_new ()
{
	...
	gconf_char_value =  gsql_conf_value_get_string (GSQLE_CONF_Firebird_CUSTOM_CHARSET);
	...
	gconf_bool_value = gsql_conf_value_get_boolean (GSQLE_CONF_Firebird_USE_CUSTOM_CHARSET);
...
on_custom_charset_changed (GtkWidget *widget, gpointer user_data)
{
	...
	gsql_conf_value_set_string (GSQLE_CONF_Firebird_CUSTOM_CHARSET, ls_value);
